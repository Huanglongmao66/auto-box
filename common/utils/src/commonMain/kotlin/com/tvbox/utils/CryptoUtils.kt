...
object CryptoUtils {
    ...
    private fun md5Digest(input: ByteArray): ByteArray {
        ...
        while (i < padded.size) {
            ...
            digest[3] = ff(digest[3], digest[0], digest[1], digest[2], m[1], s12, 0xe8c7b756)
            digest[2] = ff(digest[2], digest[3], digest[0], digest[1], m[2], s13, 0x242070db)
            digest[1] = ff(digest[1], digest[2], digest[3], digest[0], m[3], s14, 0xc1bdceee)
            digest[0] = ff(digest[0], digest[1], digest[2], digest[3], m[4], s11, 0xf57c0faf)
            digest[3] = ff(digest[3], digest[0], digest[1], digest[2], m[5], s12, 0x4787c62a)
            digest[2] = ff(digest[2], digest[3], digest[0], digest[1], m[6], s13, 0xa8304613)
            digest[1] = ff(digest[1], digest[2], digest[3], digest[0], m[7], s14, 0xfd469501)
            digest[0] = ff(digest[0], digest[1], digest[2], digest[3], m[8], s11, 0x698098d8)
            digest[3] = ff(digest[3], digest[0], digest[1], digest[2], m[9], s12, 0x8b44f7af)
            digest[2] = ff(digest[2], digest[3], digest[0], digest[1], m[10], s13, 0xffff5bb1)
            digest[1] = ff(digest[1], digest[2], digest[3], digest[0], m[11], s14, 0x895cd7be)
            digest[0] = ff(digest[0], digest[1], digest[2], digest[3], m[12], s11, 0x6b901122)
            digest[3] = ff(digest[3], digest[0], digest[1], digest[2], m[13], s12, 0xfd987193)
            digest[2] = ff(digest[2], digest[3], digest[0], digest[1], m[14], s13, 0xa679438e)
            digest[1] = ff(digest[1], digest[2], digest[3], digest[0], m[15], s14, 0x49b40821)

            digest[0] = gg(digest[0], digest[1], digest[2], digest[3], m[1], s21, 0xf61e2562)
            digest[3] = gg(digest[3], digest[0], digest[1], digest[2], m[6], s22, 0xc040b340)
            digest[2] = gg(digest[2], digest[3], digest[0], digest[1], m[11], s23, 0x265e5a51)
            digest[1] = gg(digest[1], digest[2], digest[3], digest[0], m[0], s24, 0xe9b6c7aa)
            digest[0] = gg(digest[0], digest[1], digest[2], digest[3], m[5], s21, 0xd62f105d)
            digest[3] = gg(digest[3], digest[0], digest[1], digest[2], m[10], s22, 0x02441453)
            digest[2] = gg(digest[2], digest[3], digest[0], digest[1], m[15], s23, 0xd8a1e681)
            digest[1] = gg(digest[1], digest[2], digest[3], digest[0], m[4], s24, 0xe7d3fbc8)
            digest[0] = gg(digest[0], digest[1], digest[2], digest[3], m[9], s21, 0x21e1cde6)
            digest[3] = gg(digest[3], digest[0], digest[1], digest[2], m[14], s22, 0xc33707d6)
            digest[2] = gg(digest[2], digest[3], digest[0], digest[1], m[3], s23, 0xf4d50d87)
            digest[1] = gg(digest[1], digest[2], digest[3], digest[0], m[8], s24, 0x455a14ed)
            digest[0] = gg(digest[0], digest[1], digest[2], digest[3], m[13], s21, 0xa9e3e905)
            digest[3] = gg(digest[3], digest[0], digest[1], digest[2], m[2], s22, 0xfcefa3f8)
            digest[2] = gg(digest[2], digest[3], digest[0], digest[1], m[7], s23, 0x676f02d9)
            digest[1] = gg(digest[1], digest[2], digest[3], digest[0], m[12], s24, 0x8d2a4c8a)

            digest[0] = hh(digest[0], digest[1], digest[2], digest[3], m[5], s31, 0xfffa3942)
            digest[3] = hh(digest[3], digest[0], digest[1], digest[2], m[8], s32, 0x8771f681)
            digest[2] = hh(digest[2], digest[3], digest[0], digest[1], m[11], s33, 0x6d9d6122)
            digest[1] = hh(digest[1], digest[2], digest[3], digest[0], m[14], s34, 0xfde5380c)
            digest[0] = hh(digest[0], digest[1], digest[2], digest[3], m[1], s31, 0xa4beea44)
            digest[3] = hh(digest[3], digest[0], digest[1], digest[2], m[4], s32, 0x4bdecfa9)
            digest[2] = hh(digest[2], digest[3], digest[0], digest[1], m[7], s33, 0xf6bb4b60)
            digest[1] = hh(digest[1], digest[2], digest[3], digest[0], m[10], s34, 0xbebfbc70)
            digest[0] = hh(digest[0], digest[1], digest[2], digest[3], m[13], s31, 0x289b7ec6)
            digest[3] = hh(digest[3], digest[0], digest[1], digest[2], m[0], s32, 0xeaa127fa)
            digest[2] = hh(digest[2], digest[3], digest[0], digest[1], m[3], s33, 0xd4ef3085)
            digest[1] = hh(digest[1], digest[2], digest[3], digest[0], m[6], s34, 0x04881d05)
            digest[0] = hh(digest[0], digest[1], digest[2], digest[3], m[9], s31, 0xd9d4d039)
            digest[3] = hh(digest[3], digest[0], digest[1], digest[2], m[12], s32, 0xe6db99e5)
            digest[2] = hh(digest[2], digest[3], digest[0], digest[1], m[15], s33, 0x1fa27cf8)
            digest[1] = hh(digest[1], digest[2], digest[3], digest[0], m[2], s34, 0xc4ac5665)

            digest[0] = ii(digest[0], digest[1], digest[2], digest[3], m[0], s41, 0xf4292244)
            digest[3] = ii(digest[3], digest[0], digest[1], digest[2], m[7], s42, 0x432aff97)
            digest[2] = ii(digest[2], digest[3], digest[0], digest[1], m[14], s43, 0xab9423a7)
            digest[1] = ii(digest[1], digest[2], digest[3], digest[0], m[5], s44, 0xfc93a039)
            digest[0] = ii(digest[0], digest[1], digest[2], digest[3], m[12], s41, 0x655b59c3)
            digest[3] = ii(digest[3], digest[0], digest[1], digest[2], m[3], s42, 0x8f0ccc92)
            digest[2] = ii(digest[2], digest[3], digest[0], digest[1], m[10], s43, 0xffeff47d)
            digest[1] = ii(digest[1], digest[2], digest[3], digest[0], m[1], s44, 0x85845dd1)
            digest[0] = ii(digest[0], digest[1], digest[2], digest[3], m[8], s41, 0x6fa87e4f)
            digest[3] = ii(digest[3], digest[0], digest[1], digest[2], m[15], s42, 0xfe2ce6e0)
            digest[2] = ii(digest[2], digest[3], digest[0], digest[1], m[6], s43, 0xa3014314)
            digest[1] = ii(digest[1], digest[2], digest[3], digest[0], m[13], s44, 0x4e0811a1)
            digest[0] = ii(digest[0], digest[1], digest[2], digest[3], m[4], s41, 0xf7537e82)
            digest[3] = ii(digest[3], digest[0], digest[1], digest[2], m[11], s42, 0xbd3af235)
            digest[2] = ii(digest[2], digest[3], digest[0], digest[1], m[2], s43, 0x2ad7d2bb)
            digest[1] = ii(digest[1], digest[2], digest[3], digest[0], m[9], s44, 0xeb86d391)
